...
out <- lapply(seq_along(plots), function(i) {
    ...
    download_text <- paste0("You can download the data displayed above [as a .csv file](data/estimates/", fname, ").\n")
    data_description <- "This file contains the following columns:
    <ul>
        <li><b>date</b> the date,</li>
        <li><b>new.cases</b> the number of newly reported cases on that day,</li>
        <li><b>repronum</b> the estimated reproduction number on that day,</li>
        <li><b>repronum.se</b> the (estimated) standard error of the estimate,</li>
        <li><b>ci.lower</b> the lower limit of the associated 95% confidence interval and</li>
        <li><b>ci.upper</b> the upper limit of the associated 95% confidence interval.</li>\n"
