...
# tabs for Bundeslaender sorted by tot.cases
...
# ger <- aggregate(cbind(tot.cases, tot.dead, new.cases, new.dead)
#                  ~ day + yday + date, germany, sum)
# ger$date <- ymd(ger$date)
# estimates <- cbind(ger, repronum(
#             new.cases = ger$new.cases,
#             profile = infectivity,
#             window = width,
#             delay = report.delay,
#             conf.level = 1 - alpha,
#             pad.zeros = TRUE
#             ))
# plot_ger <- plot_repronum(estimates, "Deutschland")
# 
# plots <- c(plot_ger, plots)
# names <- c(Deutschland="Deutschland", bundl)
