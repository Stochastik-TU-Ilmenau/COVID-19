...
We show results for all countries with at least `r mincases` cases `r report.delay` days ago. Results for the world and for the 20 most affected countries can be found [here](index.html). In addition, results for Germany and its federal states (Bundesländer) based on official data are available [here](germany.html) (in German).
