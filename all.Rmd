...
Above, we show results for all countries with at least `r mincases` cases `r report.delay` days ago; results for the world as well as the 20 most affected countries may be found [here](index.html). In addition, results for Germany and its Bundesländer are available [here](germany.html) (in German).
