...
out <- lapply(seq_along(plots), function(i) {
    ...
    download_text <- paste0("Die Daten zu dieser Grafik können Sie [hier](data/estimates/", fname, ") herunterladen.\n")

    data_description <- "Diese Datei enthält folgende Spalten:
    <ul>
        ...
        <li><b>ci.lower</b> die untere Grenze des 95% Konfidenzintervals und</li>
        <li><b>ci.upper</b> die obere Grenze des 95% Konfidentervals.</li>\n"
    

    paste(tab_header, chunk_start, plot_content, chunk_end, download_text, data_description, collapse = '\n') 
})
```
