...
=======
- In einer Population, in der keine Gegenmaßnahmen unternommen werden, wird die sogenannte **Basisreproduktionszahl** auf einen Wert zwischen 2,4 und 4,1 geschätzt [(Read et al. 2020)](#ref3). Schätzungen mit höheren Werten könnten durch eine beträchtliche Zahl von außen **eingeschleppter Fälle** erklärt werden.
>>>>>>> Stashed changes
