...
- Die Schätzungen werden als schwarze Linien, die zugehörigen Konfidenzintervalle als graue Streifen dargestellt, wobei die Werte gemäß der (**logarithmischen Skala** der) **linken Achse** aufgetragen sind (daher ist 0 auf der Achse nie sichtbar, sondern entspricht dem unendlich fernen unteren Ende der Achse). 
...
-  **Details** findet man im zugehörigen Bericht<!--[Bericht](reports/repronum/repronum.pdf)--> (demnächst auf Englisch verfügbar); der **Code** ist [hier](https://github.com/Stochastik-TU-Ilmenau/COVID-19/blob/gh-pages/estimator.r) verfügbar.
